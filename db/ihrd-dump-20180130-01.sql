...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_bank
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_certificate
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_document_type
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employee_certificate
CREATE TABLE IF NOT EXISTS `mst_employee_certificate` (
  `id` varchar(36) NOT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employee_document
CREATE TABLE IF NOT EXISTS `mst_employee_document` (
  `id` varchar(36) NOT NULL,
  `employee_id` varchar(36) NOT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employee_education
CREATE TABLE IF NOT EXISTS `mst_employee_education` (
  `id` varchar(36) NOT NULL,
  `employee_id` varchar(36) NOT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employee_emergency
CREATE TABLE IF NOT EXISTS `mst_employee_emergency` (
  `id` varchar(36) NOT NULL,
  `employee_id` varchar(36) NOT NULL,
  ...
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK__mst_employee` (`employee_id`),
  CONSTRAINT `FK__mst_employee` FOREIGN KEY (`employee_id`) REFERENCES `mst_employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employee_skill
CREATE TABLE IF NOT EXISTS `mst_employee_skill` (
  `id` varchar(36) NOT NULL,
  `employee_id` varchar(36) NOT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_employment_status
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_shift
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Master Shift';

-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_skill
CREATE TABLE IF NOT EXISTS `mst_skill` (
  `id` varchar(36) NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_by` varchar(36) DEFAULT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table ihrd_dev.mst_termination_reason
CREATE TABLE IF NOT EXISTS `mst_termination_reason` (
  `id` varchar(36) NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_by` varchar(36) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `trx_attendance` (
  ...
  `shift` varchar(36) NOT NULL DEFAULT '1',
  ...
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `employee_id_attendance_date_shift` (`employee_id`,`attendance_date`,`shift`),
  KEY `FK_trx_attendance_mst_shift` (`shift`),
  CONSTRAINT `FK_trx_attendance_mst_employee` FOREIGN KEY (`employee_id`) REFERENCES `mst_employee` (`id`),
  CONSTRAINT `FK_trx_attendance_mst_shift` FOREIGN KEY (`shift`) REFERENCES `mst_shift` (`shift_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `trx_leave_request` (
  ...
  `request_by` varchar(36) NOT NULL,
  `request_date` datetime NOT NULL,
  `type` enum('leave','sick','permission','late') NOT NULL,
  `start_date` datetime NOT NULL,
  `end_date` datetime NOT NULL,
  `duration` int(11) NOT NULL,
  ...
  `process_note` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_trx_leave_request_mst_employee` (`request_by`),
  CONSTRAINT `FK_trx_leave_request_mst_employee` FOREIGN KEY (`request_by`) REFERENCES `mst_employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `trx_overtime_request` (
  ...
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_trx_overtime_request_mst_employee` (`request_by`),
  CONSTRAINT `FK_trx_overtime_request_mst_employee` FOREIGN KEY (`request_by`) REFERENCES `mst_employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Data exporting was unselected.
-- Dumping structure for view ihrd_dev.v_attendance
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `v_attendance` (
	`id` VARCHAR(36) NOT NULL COLLATE 'latin1_swedish_ci',
	`employee_id` VARCHAR(36) NOT NULL COLLATE 'latin1_swedish_ci',
	`attendance_date` DATE NULL,
	`shift` VARCHAR(36) NOT NULL COLLATE 'latin1_swedish_ci',
	`overtime` INT(11) NULL,
	`attend` TINYINT(1) NULL,
	`reason_type` ENUM('sick','leave','alpha') NULL COLLATE 'latin1_swedish_ci',
	...
	`shift_name` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
...
CREATE TABLE `v_leave_request` (
	...
	`request_date` DATETIME NOT NULL,
	`type` ENUM('leave','sick','permission','late') NOT NULL COLLATE 'latin1_swedish_ci',
	`start_date` DATETIME NOT NULL,
	`end_date` DATETIME NOT NULL,
	`duration` INT(11) NOT NULL,
...
-- Dumping structure for view ihrd_dev.v_overtime_request
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `v_overtime_request` (
	`id` VARCHAR(36) NOT NULL COLLATE 'latin1_swedish_ci',
	`request_by` VARCHAR(36) NOT NULL COLLATE 'latin1_swedish_ci',
	`request_date` DATETIME NOT NULL,
	`start_time` TIME NOT NULL,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `v_attendance` AS select
    lr.*,
    emp.nik,
  ...
  from trx_attendance lr
    join mst_employee emp on emp.id = lr.employee_id
    join mst_job j on j.id = emp.current_job_id
    join mst_department dept on dept .id = emp.current_department_id 
    join mst_shift shift on shift.shift_id = lr.shift ;
...
-- Dumping structure for view ihrd_dev.v_overtime_request
-- Removing temporary table and create final VIEW structure
DROP TABLE IF EXISTS `v_overtime_request`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `v_overtime_request` AS select
    lr.*,
    emp.nik,
    emp.full_name as full_name,
    j.id as job_id,
